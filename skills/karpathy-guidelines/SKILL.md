...
description: Behavioral guidelines to reduce common LLM coding mistakes. Use when writing, reviewing, or refactoring code to avoid overcomplication, make surgical changes, surface assumptions, define verifiable success criteria, and signal uncertainty.
license: MIT
---
...
In these rules, "you" refers to the AI agent.
